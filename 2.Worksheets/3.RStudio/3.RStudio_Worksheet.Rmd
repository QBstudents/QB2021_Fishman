...
cor.zoo <- corr.test(sbs, method="kendall",adjust="BH")
...
```
> Answer 6:
The biomass of the various taxa appear to be uncorrelated, when uses the Kendall approach with BH p-value correction. The massive increase in biomass with high nutrients is almost entirely driven by high concentrations of SIMO and CHYD. CHYD in particular has biomasses orders of magnitude higher than other taxa. BOSM, NAUP, and DLUM are almost at negligible concentration. CAL, DIAP, CYCL, and BOSM all peak at medium nutrient concentrations, while NAUP and DLUM decrease with increasing nutrients. 
